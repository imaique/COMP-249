...
public class addressDriver2 {

    /**
     * Takes an array of addresses and attempts to copy it.
     * @param addresses The array of addresses to be copied
     * @return An attempted coppy of the array
     */

    /*
    This does not create a true copy of the array. For this to be the case, we would need to use a clone method or to
    identify which class the address to be copied is and use the corresponding copy constructor to copy it. In this method, all it does
    is copy the attributes of the base class, Address, which means that it only copies validFrom and validTo.
     */
    public static Address[] copyAddresses(Address[] addresses){
        Address[] copy = new Address[addresses.length];
        for (int i = 0; i<addresses.length;i++){
            copy[i] = new Address(addresses[i]);
        }
        return copy;
    }
    ...
    public static void main(String[] args){
        ...
        System.out.println("");
        System.out.println("Copied Address: ");
